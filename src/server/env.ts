...
export const ENV_CATALOG: EnvVarSpec[] = [
  ...
  // --- Object Storage (PLATFORM-002) ---
  {
    ...
    description: 'Proveedor activo: local | s3 | r2.',
    secret: false,
    requiredIn: [],
    usedToday: true,
  },
  {
    ...
    description: 'Carpeta de objetos del proveedor local (dev).',
    secret: false,
    requiredIn: [],
    usedToday: true,
  },
  {
    name: 'MAX_UPLOAD_MB',
    description: 'Tamaño máximo de subida (MB, default 25).',
    secret: false,
    requiredIn: [],
    usedToday: true,
  },
  {
    ...
    description: 'TTL de URLs firmadas (segundos).',
    secret: false,
    requiredIn: [],
    usedToday: true,
  },
  ...
  {
    name: 'STORAGE_REGION',
    description: 'Región del storage (R2: auto).',
    secret: false,
    requiredIn: [],
    usedToday: false,
  },
  ...
  },
  {
    ...
    description: 'Access key id del storage.',
    secret: true,
    requiredIn: ['production'],
    usedToday: false,
  },
  {
    ...
    description: 'Secret access key del storage.',
    secret: true,
    requiredIn: ['production'],
    usedToday: false,
  },
